...
mod tests {
    ...
    async fn test_nested_response_body_format() {
        ...
        assert_eq!(parsed["error"]["message"], "Authentication error: invalid token");
    }
    ...
    async fn test_three_layer_nested_database_error() {
        ...
        assert_eq!(parsed["error"]["message"], "Database connection failed: connection timeout");
    }
    ...
    async fn test_three_layer_nested_validation_error() {
        ...
        assert_eq!(parsed["error"]["message"], "Validation failed: email format invalid");
    }
    ...
    async fn test_three_layer_nested_permission_error() {
        ...
        assert_eq!(parsed["error"]["message"], "Permission denied: admin access required");
    }
